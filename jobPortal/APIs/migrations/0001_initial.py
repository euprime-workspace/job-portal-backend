    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='recruitor', to='APIs.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='APIs.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='HistoricalFile',
